                ...
                ScrollView{
                    ...
                    VStack(alignment: .leading){
                        ...
                        Text("1. Einleitung")
                            ...
                            .font(.system(size: 15, design: .monospaced))
                            .padding(EdgeInsets(top: 10, leading: 0, bottom: 10, trailing: 0))
                        Text("Diese Datenschutzerklärung gilt für die iOS-App „Meet me at the campfire“, im Folgenden „App“ genannt, die im Apple App Store veröffentlicht wurde und frei verfügbar ist. Entwickelt und veröffentlicht wurde die App von Mike Reichenbach, Brunnenstr. 2/4 in 76327 Pfinztal, im weiteren Verlauf „Entwickler“ genannt. Der Schutz Ihrer persönlichen Daten ist uns ein besonderes Anliegen. In dieser Datenschutzerklärung informieren wir Sie über die Verarbeitung Ihrer personenbezogenen Daten bei der Nutzung unserer App.")
                        Divider()
                        Text("2. Verantwortlicher")
                            .bold()
                            .font(.system(size: 15, design: .monospaced))
                            .padding(EdgeInsets(top: 10, leading: 0, bottom: 10, trailing: 0))
                        Text("Der Verantwortliche für die Verarbeitung Ihrer personenbezogenen Daten im Zusammenhang mit der App ist: Mike Reichenbach, Brunnenstr. 2/4 in 76327 Pfinztal. Zum Datenschutz können Sie jederzeit unter der oben genannten Adresse oder per E-Mail an meetmeatthecampfire@gmail.com an den Entwickler wenden.")
                        Divider()
