...
struct CalendarYearlyView_Previews: PreviewProvider {
    static var previews: some View {
        CalendarYearlyView(dateVm: CalendarViewModel(date: Date()), calendarDetailItemVm: CalendarDetailItemViewModel(calendarItemModel: LogBookModel(userId: "1", formattedDate: "", logBookText: "", laditude: 0.0, longitude: 0.0), calendarVm: CalendarViewModel(date: Date())))
    }
}
