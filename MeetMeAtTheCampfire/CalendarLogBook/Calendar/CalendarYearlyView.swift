...
//                        VStack{
//                            ForEach(year.getAllMonths(), id:  \.self) { month in
//                                CalendarMonthlyView(month: month, calendarDetailItemVm: calendarDetailItemVm)
//                                    .id(month.get(.month))
//                            }
//                        }
//                    }
...
//    
//    let columns = Array(repeating: GridItem(.flexible()), count: 7)
//    @State var dayIsEmpty: Bool = false
//    var month: Date
//    @ObservedObject var calendarDetailItemVm: CalendarDetailItemViewModel
//    
//    init(month: Date, calendarDetailItemVm: CalendarDetailItemViewModel) {
//        self.month = month
//        self.calendarDetailItemVm = calendarDetailItemVm
//        calendarDetailItemVm.readLogBookText(formattedDate: CalendarUtils.getMonthCaption(month))
//    }
//    
//    var body: some View {
//        VStack {
...
//                ForEach(month.getAllDaysToNextMonth(), id: \.self){ day in
//                    NavigationLink(destination: NavigationLazyView(destinationView(for: day))) {
//                        CalendarDailyView(dayIsEmpty: entryExists(for: day), date: day)
//                            .onAppear{
//                                print("entryExists \(entryExists(for: day))")
//                                }
//                        // Negiere den Wert von entryExists, da dayIsEmpty false sein soll, wenn ein Eintrag vorhanden ist
//                    }
//                }
//            }
//        }
//    }
//    
//    private func entryExists(for date: Date) -> Bool {
//        let formattedDate = CalendarUtils.getDayCaption(date)
//        for entry in calendarDetailItemVm.newEntryLogs {
//            if entry.formattedDate == formattedDate {
//                return true
//            }
//        }
//        return false
